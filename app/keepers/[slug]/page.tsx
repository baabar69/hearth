...
const KEEPERS: Keeper[] = [
  {
    ...
    whatPeopleBring: [
      ...
      "Identity questions: being too much of one thing and not enough of another",
  ...
  },
  {
    ...
    whatPeopleBring: [
      ...
      "Fatherhood: providing for everyone while slowly losing yourself",
      "Career crossroads where the 'right' choice was made for the family and not the self",
      "The weight of being the one others lean on. The quiet expectation of stoic strength",
    ...
    notForNote:
      "Faisal is a peer supporter, not a licensed therapist. He does not diagnose or provide clinical care. For men dealing with clinical depression, PTSD, or active crisis, The Bridge connects you with licensed therapists (including male therapists) matched by hand for the contexts our members live inside.",
  },
  {
    slug: "priya-s",
    name: "Priya S.",
    ...
    fullBio:
      "Priya has raised two children through every season nobody warns you about. She knows postpartum from the inside: the fog, the identity rupture, the way the love and the loss can coexist without anyone telling you that's allowed. She is not here to tell you that motherhood is beautiful. She knows it is. She's also here for the part that nobody talks about at the baby shower. Priya does not have a professional background in counseling. She has a lived background, a demanding career in public health, and the particular education of being the first person in her family to raise children far from where she grew up. She was trained by Hearth to hold space, notice patterns, and know her scope. She will stay with you in the uncertain middle.",
    whatPeopleBring: [
      "Postpartum identity loss: who you were before, who you are now, and the gap between",
      "The specific anxiety of new parenthood without a manual",
      "In-law dynamics in the context of new parenthood",
      "The guilt of not being the mother you planned to be",
      "New parenthood as a couple, and what it does to the relationship",
    ],
    notesFromKeeper:
  ...
  },
  {
    ...
    whatPeopleBring: [
      ...
      "The weight of major life transitions: the loneliness, the displacement, the grief of what was left",
      "Grief for parents who were also the bridge to a whole world now gone",
      "The cost of code-switching between work, family, faith, and self",
    ],
    notesFromKeeper:
    ...
    notForNote:
      "Hassan is a peer supporter with pastoral counseling training. He is not a licensed therapist. For clinical grief, depression, or crisis, The Bridge provides licensed clinicians, matched by hand for fit. Hassan will make the introduction and stay in your corner throughout.",
  },
];

// The set of Keepers is fixed and fully enumerated by generateStaticParams, so any
